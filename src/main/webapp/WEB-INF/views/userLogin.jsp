...
<body>
<sform:form action="gologin" method="post" modelAttribute="login">
<h1 style="color: #FFFFFF">Login Form<h1>
 <sform:input  path="email" placeholder="EmailId" cssClass="name"  />
  <sform:input  path="password" placeholder="Password" cssClass="email" />

<input type="submit"  value="Login" class="btn" />
</sform:form>
<a href=register?proId=${pr.productId}>Register</a>
</body>
</html>