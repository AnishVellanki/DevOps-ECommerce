...
body {
	  background:#FA8072 url(http://www.luismruiz.com/img/blured.jpg)no-repeat center center fixed;
...
<h1 style="color: #FFFFFF"> ${form} </h1>
 <sform:input  path="categoryName" placeholder="Category Name" cssClass="name"  />
  <sform:input  path="categoryDescription" placeholder="Category Description" cssClass="email" />
  <sform:input  path="categoryId" placeholder="Category Id" cssClass="email" type="hidden"/>
